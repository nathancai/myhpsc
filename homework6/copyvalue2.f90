...
program copyvalue
    ...
    if (proc_num==0) then
        i = 55
        print '("Process ",i3," setting      i = ",i3)', 3 - proc_num, i
        ...
        print '("Process ",i3," receives     i = ",i3)', 3 - proc_num, i
        i = i - 1
        print '("Process ",i3," sends        i = ",i3)', 3 - proc_num, i
        ...
        print '("Process ",i3," ends up with i = ",i3)', 3 - proc_num, i
      endif
